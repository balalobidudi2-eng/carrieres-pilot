...
const plans = [
  {
    ...
    badge: null,
    features: [
      { label: '1 CV / jour', included: true },
      { label: '1 lettre / jour', included: true },
      { label: '10 recherches / jour', included: true },
      { label: '5 matchings IA / jour', included: true },
      { label: 'Candidatures automatiques', included: false },
      { label: 'Envoi email SMTP', included: false },
      { label: 'Automatisation formulaires', included: false },
  ...
  },
  {
    ...
    badge: 'Populaire',
    features: [
      { label: '5 CV / jour', included: true },
      { label: '5 lettres / jour', included: true },
      { label: '100 recherches / jour', included: true },
      { label: '50 matchings IA / jour', included: true },
      { label: '10 candidatures auto / jour', included: true },
      { label: 'Envoi email SMTP', included: true },
      { label: 'Automatisation formulaires', included: true },
      { label: 'Support prioritaire', included: false },
    ],
    cta: 'Passer au Pro',
  ...
  },
  {
    ...
    badge: null,
    features: [
      { label: '50 CV / jour', included: true },
      { label: '50 lettres / jour', included: true },
      { label: '500 recherches / jour', included: true },
      { label: '200 matchings IA / jour', included: true },
      { label: '100 candidatures auto / jour', included: true },
      { label: 'Envoi email SMTP', included: true },
      { label: 'Automatisation formulaires', included: true },
      { label: 'Support prioritaire + Analytics', included: true },
    ],
    cta: 'Passer Expert',
